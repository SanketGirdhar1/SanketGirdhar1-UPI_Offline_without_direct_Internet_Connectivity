...
public class SettlementService {
    ...
    /**
     * Serializable isolation ensures that when two concurrent settlements both touch
     * the same account (e.g., carol is sender in one and receiver in another),
     * they queue up rather than conflicting with an OptimisticLockException.
     */
